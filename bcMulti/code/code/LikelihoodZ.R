  ...
  , methods = list(
    ...
    sumLikelihood = function() {
      ...
      for (compound in names(data.sets)) {
        ...
        logerror(paste("LIKELOHOOD TEST VALUES", id.log, ":compound", compound, "nse", nse, "r2", r2, "d.cum", d.cum, "d", d, "sumGaussian", z.val))
        ...
        measurementsLikeli <- c(measurementsLikeli, z.val)
    ...
    z.likelihood = function(compound) {
